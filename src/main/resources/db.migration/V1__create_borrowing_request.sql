...
CREATE TABLE RoomBorrowRequests (
...
CREATE TABLE EquipmentBorrowRequests (
...
CREATE TABLE EquipmentBorrowRequestDetails (
    ...
    FOREIGN KEY (BorrowRequestID) REFERENCES EquipmentBorrowRequests(UniqueID),
...
CREATE TABLE TransactionsLog (
    ...
    FOREIGN KEY (UserID) REFERENCES sem_db.users(id),
    FOREIGN KEY (RoomRequestID) REFERENCES RoomBorrowRequests(UniqueID),
    FOREIGN KEY (EquipmentRequestID) REFERENCES EquipmentBorrowRequests(UniqueID),
...
CREATE TABLE ReturnRequestDetails (
    ...
    FOREIGN KEY (ReturnID) REFERENCES ReturnRequests(UniqueID),
